...
import com.example.umc7th.member.dto.OAuth2DTO;
...
public class OAuth2ServiceImpl implements OAuth2Service {
    ...
    public LoginResponseDTO login(String code) {
        ...
        HttpEntity<MultiValueMap> request = new HttpEntity<>(map,
                httpHeaders); // Header와 Body를 이용하여 요청에 보낼 HttpEntity 생성
        ...
        try {
            ...
            throw new MemberCustomException(MemberErrorCode.OAUTH_TOKEN_FAIL); // 토큰 DTO로 변경하지 못한 경우 Exception 보냄
        }
        ...
        try {
            ...
            throw new MemberCustomException(MemberErrorCode.OAUTH_USER_INFO_FAIL); // 사용자 정보를 가져오지 못한 경우 Exception 발생
        }
