...
public class OpenApiQueryServiceImpl implements OpenApiQueryService {
    ...
    @Override
    public OpenApiResponseDTO.SearchStayResponseListDTO searchStay(String arrange, int page, int offset, String lang) {
        // Web Client 가져오기
        WebClient webClient = openApiWebClient.getTourWebClient(lang);
