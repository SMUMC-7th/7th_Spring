package com.example.umc7th.domain.ouath.service;
...
import com.example.umc7th.domain.ouath.dto.OAuth2DTO;
...
public class OAuth2ServiceImpl implements OAuth2Service {
    ...
    public MemberResponseDTO.MemberTokenDTO login(String code) {
        ...
        // 요청을 보내서 응답 받아오기
        ResponseEntity<String> response1 = getStringResponseEntity(restTemplate, request);
        ...
        Member member = getMember(profile);

        return getMemberTokenDTO(member);
    }

    private Member getMember(OAuth2DTO.KakaoProfile profile) {
    ...
    private ResponseEntity<String> getStringResponseEntity(RestTemplate restTemplate, HttpEntity<MultiValueMap> request) {
    ...
    private MemberResponseDTO.MemberTokenDTO getMemberTokenDTO(Member member) {
