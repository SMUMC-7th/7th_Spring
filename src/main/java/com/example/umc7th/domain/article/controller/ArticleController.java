...
public class ArticleController {
	...
	private final ArticleQueryService articleQueryService; // 조회용
	private final ArticleCommandService articleCommandService; // 생성, 수정, 삭제용
	...
	public CustomResponse<ArticleResponseDTO.CreateArticleResponseDTO> createArticle(@RequestBody ArticleRequestDTO.CreateArticleDTO dto) {
		Article article = articleCommandService.createArticle(dto); // 특정 요청을 수행할 서비스를 실행
